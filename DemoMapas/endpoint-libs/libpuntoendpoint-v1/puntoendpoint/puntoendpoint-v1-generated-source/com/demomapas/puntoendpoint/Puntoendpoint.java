...
public class Puntoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * parameters, call the {@link GetLast#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  ...
  public class GetLast extends PuntoendpointRequest<com.demomapas.puntoendpoint.model.CollectionResponsePunto> {

    private static final String REST_PATH = "collectionresponse_punto";
